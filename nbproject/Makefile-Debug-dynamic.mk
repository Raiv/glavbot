...
${OBJECTDIR}/src/common/gvb-opt.o: src/common/gvb-opt.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc/camera -Isrc/common -Isrc/network -Isrc/ui `pkg-config --cflags glib-2.0` `pkg-config --cflags gobject-2.0` `pkg-config --cflags ncurses` `pkg-config --cflags gio-2.0`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/common/gvb-opt.o src/common/gvb-opt.c
...
${OBJECTDIR}/src/tests/gvb-h264-parser.o: src/tests/gvb-h264-parser.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc/camera -Isrc/common -Isrc/network -Isrc/ui `pkg-config --cflags glib-2.0` `pkg-config --cflags gobject-2.0` `pkg-config --cflags ncurses` `pkg-config --cflags gio-2.0`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tests/gvb-h264-parser.o src/tests/gvb-h264-parser.c
