...
LDLIBSOPTIONS=-L3rdparty/glib-2.0/2.48.1/armv71/libs -ldl -lresolv -lz -lrt -lm -Wl,-Bstatic -lgio-2.0 -lgmodule-2.0 -lgobject-2.0 -lglib-2.0 -Wl,-Bdynamic `pkg-config --libs ncurses` `pkg-config --libs libffi` `pkg-config --libs libpcre` -lpthread   
