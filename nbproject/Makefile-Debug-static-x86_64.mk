...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/glavbot_github: ${OBJECTFILES}
	...
	gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/glavbot_github ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/common/gvb-opt.o: src/common/gvb-opt.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} "$@.d"
	$(COMPILE.c) -g -I3rdparty/glib-2.0/2.48.1/x86_64/include -Isrc/common -Isrc/camera -Isrc/network -Isrc/ui -Isrc/tests `pkg-config --cflags ncurses` `pkg-config --cflags libffi` `pkg-config --cflags libpcre`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/common/gvb-opt.o src/common/gvb-opt.c
...
${OBJECTDIR}/src/tests/gvb-h264-parser.o: src/tests/gvb-h264-parser.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I3rdparty/glib-2.0/2.48.1/x86_64/include -Isrc/common -Isrc/camera -Isrc/network -Isrc/ui -Isrc/tests `pkg-config --cflags ncurses` `pkg-config --cflags libffi` `pkg-config --cflags libpcre`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tests/gvb-h264-parser.o src/tests/gvb-h264-parser.c
